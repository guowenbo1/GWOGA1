...
from genetic_selection import gscv
# genetic_selection.
...
# def drogonFlyCros(ind1, ind2, indpb):
...
#     print('enemy location',enemy)
#     return ind1,ind2

def wolfCros(ind1,ind2):
...
def cxSimulatedBinary(ind1, ind2, eta=0.2):
...
def cxSimulatedBinaryBounded(ind1, ind2, eta=0.2, low=0, up=10):
    """Executes a simulated binary crossover that modify in-place the input
    individuals. The simulated binary crossover expects :term:`sequence`
    individuals of floating point numbers.
...
def cxESBlend(ind1, ind2, alpha=0.5):
